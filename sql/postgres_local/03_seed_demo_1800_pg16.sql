...
--   ✓ auth_mock reemplazado por public.usuarios_mock (tabla definitiva)
...
--   ✓ Columna 'estado' añadida a cuentas (requerida por v3.0)
--   ✓ Columna 'saldo_post' añadida a transacciones (requerida por v3.0)
-- ============================================================
...
BEGIN
  ...
  LOOP
    ...
    FOR c IN 1..5 LOOP
      ...
      -- ── 1. INSERTAR EN usuarios_mock (reemplaza auth_mock) ─
      -- Password hash ficticio para demo (no es un hash real bcrypt)
      INSERT INTO public.usuarios_mock (id, email, password_hash, nombre, apellido, rol)
      VALUES (
        uid,
        email_val,
        '$2b$12$demo_hash_no_usar_en_produccion_' || cli_global::TEXT,
        nombre,
        apellido1 || ' ' || apellido2,
        'cliente'
      )
...
-- ── Verificación final ────────────────────────────────────
SELECT 'usuarios_mock'          AS tabla, COUNT(*) AS registros FROM public.usuarios_mock
...
-- ============================================================
-- FIN — 03_seed_demo_1800_pg16.sql · v3.0 · 2026
-- ============================================================
